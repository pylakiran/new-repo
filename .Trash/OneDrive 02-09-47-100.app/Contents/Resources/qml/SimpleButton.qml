...
Rectangle {
    ...
    property bool performCallbackOnSpace: true;
    ...
    property color primarycolor:    (colorScheme == null ? "red" : colorScheme.button)
    property color hovercolor:      (colorScheme == null ? "pink" : colorScheme.button_hovering)
    property color pressedcolor:    (colorScheme == null ? "salmon" : colorScheme.button_pressed)
    ...
    Keys.onSpacePressed: performCallbackOnSpace ? doCallback(true) : nil;
    ...
    Text {
        ...
        color: (colorScheme == null ? "orange" :
                    (ma.containsPress ?  colorScheme.button_text_pressed :
                    (ma.containsMouse ?  colorScheme.button_text_hovering :
                                         colorScheme.button_text)))
