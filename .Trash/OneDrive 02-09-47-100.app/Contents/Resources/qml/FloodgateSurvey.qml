...
Rectangle {
    ...
    ListView {
        ...
        delegate: RadioButton {
            width: parent.width
            height: contentItem.contentHeight + linePadding
            padding: 0

            text: getResponseString(index)
            
           // See accessibility note for ListView above. This selects the current radio button 
           // being navigated while not in scan-mode if it is not already selected.
