...
Rectangle {
    ...
    Rectangle {
        ...
        Row {
            ...
            SimpleButtonLink {
                id: restorePurchaseLink

                textcontrol.text: _("PurchaseRestoreLinkText")
                textcontrol.font.pixelSize: 14
                textcontrol.font.family: ".SF NS Text"
                textcontrol.font.underline: false
                
                Accessible.name: textcontrol.text
                anchors.verticalCenter: parent.verticalCenter
                callback: viewModel.onRestorePurchaseClicked
            }
            ...
            SimpleButton {
                ...
                enabled: restoreLinkRow.visible
                width: 14
                height: 14
                ...
                useImage: true
                imagecontrol.source: fullImageLocation + "moreInfo.svg"
                imagecontrol.width: 16
                imagecontrol.height: 16
                imagecontrol.sourceSize.width:  16
                imagecontrol.sourceSize.height: 16

                Accessible.name: _("PurchaseRestoreHelpLinkText")
                Accessible.ignored: !visible

                callback: function() {
                    Qt.openUrlExternally("https://go.microsoft.com/fwlink/?LinkId=2095521");
                }
            }
        }
        ...
        ScrollView {
            ...
            anchors.top: restoreLinkRow.bottom
            anchors.topMargin: 10
            anchors.left: parent.left
            anchors.leftMargin: plansPage.sideMargins
            anchors.right: parent.right
            ...
            Column {
                ...
                Text {
                    ...
                    text: _("PurchaseSubscriptionTermsBodyAlta")
                    color: Colors.common.text
                    wrapMode: Text.WordWrap
                    font.family: ".SF NS Text"
                    font.pixelSize: 10
    ...
    SimpleButton {
        ...
        textcontrol.color: Colors.in_app_purchase.white_button_text
