...
Rectangle {
    ...
    Rectangle {
        ...
        color: HelperFunctions.chooseErrorOrWarningBGColor(
            errorsModel.isWarningsOnly,
            (errorListHeaderMouseArea.containsMouse || errorListHeaderMouseArea.activeFocus))
    ...
    ListView {
        ...
        signal primaryAction(int index, bool isCheckboxChecked);
        signal secondaryAction(int index, bool isCheckboxChecked);
        signal mainAction(int index, bool isCheckboxChecked);
        signal learnMoreClicked(int index, bool isCheckboxChecked);
